...
static void systick_ms_setup(void)
{
...
const char *code[] = {
 ...
 "AT+" "CLASS" "=" "0" "\r\n\0",
 "AT+" "ADDR" "=" "66554477" "\r\n\0",
 "AT+" "NSK" "=" "112233445566deab546829cb361cab7" "\r\n\0",
 "AT+" "ASK" "=" "887766554433bcfacde52476cad598b" "\r\n\0",
 "AT+" "RX2DR" "=" "3" "\r\n\0",
 "AT+" "AK" "=" "00112233445566778899aabbccddeeff" "\r\n\0",
 "AT+" "APPEUI" "=" "abc123adf135cbd8" "\r\n\0",
 "AT+" "JOIN" "=" "1" "\r\n\0",
 "AT+" "SEND" "=" "0" "\r\n\0",
 "AT+APPEUI\r\n\0",
 "AT+NSK\r\n\0",
...
static void send_serial(enum lora_cmd cmd)
{
...
static void lora_config_otaa(){

 send_serial(AT);


 send_serial(AT_CLASS);
 ...
 send_serial(AT_RX2DR);


 send_serial(AT_AK);


 send_serial(AT_APPEUI);
